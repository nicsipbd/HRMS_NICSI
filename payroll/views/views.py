    ...
    if is_ajax and request.method == "GET":
        ...
        for employee in employees:
            employee_label.append(
                f"{employee.employee_first_name} {employee.employee_father_name}"
            )
        ...
        list_of_employees = list(
            Employee.objects.values_list(
                "id", "employee_first_name", "employee_father_name"
            )
        )
        response = {
            "dataset": dataset,
...
def payslip_export(request):
    ...
    if employee_payslip_list:
        for payslip in employee_payslip_list:
            ...
            table1_data.append(
                {
                    "employee": f"{payslip.employee_id.employee_first_name} {payslip.employee_id.employee_father_name}",
