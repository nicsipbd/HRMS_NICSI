...
DATABASES = {
    'default': {
        ...
        'NAME': 'NICSIHRMS',  # Replace with your database name
        'USER': 'postgres',  # Replace with your PostgreSQL username
        'PASSWORD': 'Nicsi@123',   # Replace with your PostgreSQL password
        'HOST': '127.0.0.1',           # Or use 'localhost' if pgAdmin and Django are on the same machine
...
LOCALE_PATHS = [
    join(BASE_DIR, "horilla22", "locale"),
]
