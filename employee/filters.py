...
class EmployeeFilter(FilterSet):
    ...
    employee_father_name = django_filters.CharFilter(lookup_expr="icontains")
        ...
        if not search_field:
            ...
            if first_name and last_name:
                queryset = queryset.filter(
                    ...
                    employee_father_name__icontains=last_name,
                )
            elif first_name:
                queryset = queryset.filter(employee_first_name__icontains=first_name)
            elif last_name:
                queryset = queryset.filter(employee_father_name__icontains=last_name)
        else:
            if search_field == "reporting_manager":
                ...
                if first_name and last_name:
                    queryset = queryset.filter(
                        ...
                        employee_work_info__reporting_manager_id__employee_father_name__icontains=last_name,
                    )
                elif first_name:
                    queryset = queryset.filter(
                        employee_work_info__reporting_manager_id__employee_first_name__icontains=first_name
...
class DocumentRequestFilter(FilterSet):
    ...
    class Meta:
        ...
        fields = [
            ...
            "employee_id__employee_father_name",
