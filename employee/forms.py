...
excel_columns = [
    ("badge_id", trans("Attendence Id")),
    ("employee_first_name", trans("First Name")),
    ("employee_father_name", trans("Father 1 Name")),
    ("email", trans("Email")),
    ("phone", trans("Phone")),
    ...
    ("employee_work_info__email", trans("Work Order No1")),
    ...
    ("employee_work_info__reporting_manager_id", trans("Manager")),
