...
class Employee(models.Model):
    ...
    choice_Qualification = (
        ("choose", trans("Choose Qualification")),
        ("10th", trans("10th")),
        ("12th", trans("12th")),
        ("Graduate", trans("Graduate")),
        ("Post-Graduate", trans("Post-Graduate")),
        ("Professional Degrees", trans("Professional Certificate")),        
    ...
    employee_first_name = models.CharField(
        max_length=200, null=False, verbose_name=_("Full Name")
    )
    employee_father_name = models.CharField(
        max_length=200, null=True, blank=True, verbose_name=_("Father Name")
    )
    ...
    # qualification = MultiSelectField(
    #     choices=choice_Qualification,
    ...
    # def __str__(self):
    #     return ", ".join(self.qualification) if self.qualification else "No Qualification Selected"
    ...
    def get_full_name(self):
        ...
        """
        return (
            f"{self.employee_first_name } {self.employee_father_name}"
            if self.employee_father_name
            ...
            try:
                REPLACE_EMPLOYEE_CHOICES = [("", _("---Choose employee---"))] + [
                    ...
                    for employee_id, first_name, last_name in Employee.objects.filter(
                        is_active=True
                    ).values_list("id", "employee_first_name", "employee_father_name")
                ]
    ...
    def __str__(self) -> str:
        last_name = (
            self.employee_father_name if self.employee_father_name is not None else ""
        )
    ...
    class Meta:
        ...
        unique_together = ("employee_first_name", "employee_father_name", "email")
        permissions = (
...
class EmployeeWorkInformation(models.Model):
    ...
    email = models.CharField(
        max_length=254, blank=True, null=True, verbose_name=_("Work Order No.")
    )
    ...
    basic_salary = models.IntegerField(
        null=True, blank=True, default=0, verbose_name=_("Basic Salary1")
    )
...
class EmployeeBankDetails(HorillaModel):
    ...
    any_other_code1 = models.CharField(max_length=50, verbose_name="BANK IFSC No.")
