    ...
    def search_method(self, queryset, _, value: str):
        ...
        for split in values:
            empty = empty | (
                ...
                | queryset.filter(managers__employee_father_name__icontains=split)
                | queryset.filter(assignees__employee_first_name__icontains=split)
                | queryset.filter(assignees__employee_father_name__icontains=split)
    ...
    def search_method(self, queryset, _, value: str):
        ...
        for split in values:
            empty = empty | (
                ...
                | queryset.filter(
                    objective_id__managers__employee_father_name__icontains=split
                )
            )
        return empty
    ...
    def search_method(self, queryset, _, value: str):
        ...
        for split in values:
            empty = (
                ...
                | (queryset.filter(employee_id__employee_father_name__icontains=split))
